...
if(isset($_GET['target'])){
    ...
    if($_GET['target'] == 'attach_1') {
        $sql = mysqli_query($conn, "UPDATE tto_report SET attach_1 = '' WHERE report_id = 1");
        if ($sql) {
            echo '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
        }
    }
    if($_GET['target'] == 'attach_2'){
        $sql =mysqli_query($conn, "UPDATE tto_report SET attach_2 = '' WHERE report_id = 1");
        if($sql){
            echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
        }
    }
        if($_GET['target'] == 'attach_3') {
            $sql = mysqli_query($conn, "UPDATE tto_report SET attach_3 = '' WHERE report_id = 1");
            if ($sql) {
                echo '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_4'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_4 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_5'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_5 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_6'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_6 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_7'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_7 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_8'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_8 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_9'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_9 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_10'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_10 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_11'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_11 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_12'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_12 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_13'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_13 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_14'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_14 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_15'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_15 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_16'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_16 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_17'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_17 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_18'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_18 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }if($_GET['target'] == 'attach_19'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_19 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
        if($_GET['target'] == 'attach_20'){
            $sql =mysqli_query($conn, "UPDATE tto_report SET attach_20 = '' WHERE report_id = 1");
            if($sql){
                echo  '<meta http-equiv="refresh" content="0; \'public_report.php\' "/>';
            }
        }
...
$sel_setting = mysqli_query($conn, "select * from tto_report");
if (mysqli_num_rows($sel_setting) != 1) {
$insert = mysqli_query($conn, "INSERT INTO `tto_report`(`report_id`, `title_1`, `title_2`, `title_3`, `title_4`, `title_5`, `title_6`, `title_7`, `title_8`, `title_9`, `title_10`, `title_11`, `title_12`, `title_13`, `title_14`, `title_15`, `title_16`, `title_17`, `title_18`, `title_19`, `title_20`, `text_1`, `text_2`, `text_3`, `text_4`, `text_5`, `text_6`, `text_7`, `text_8`, `text_9`, `text_10`, `text_11`, `text_12`, `text_13`, `text_14`, `text_15`, `text_16`, `text_17`, `text_18`, `text_19`, `text_20`)
                                                            VALUES (1,
                                                            '$_POST[title_1]',
                                                            '$_POST[title_2]',
                                                            '$_POST[title_3]',
...
$insert = mysqli_query($conn, "UPDATE tto_report SET
                                        report_id = 1,
...
if (mysqli_num_rows($sel_setting) != 1) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO `tto_report`(`title_1`, `title_2`, `title_3`, `title_4`, `title_5`, `title_6`, `title_7`, `title_8`, `title_9`, `title_10`, `title_11`, `title_12`, `title_13`, `title_14`, `title_15`, `title_16`, `title_17`, `title_18`, `title_19`, `title_20`, `text_1`, `text_2`, `text_3`, `text_4`, `text_5`, `text_6`, `text_7`, `text_8`, `text_9`, `text_10`, `text_11`, `text_12`, `text_13`, `text_14`, `text_15`, `text_16`, `text_17`, `text_18`, `text_19`, `text_20`)
                                                            VALUES (
                                                            '$_POST[title_1]',
                                                            '$_POST[title_2]',
                                                            '$_POST[title_3]',
...
<div class="panel-heading"><b>نموذج تقييم  مكتب نقل وتسويق التكنولوجيا  TTO  </b></div>
