...
if(isset($_POST['submit'])){
    $sel_setting =mysqli_query($conn, "select * from tto_users");
    if(empty($_POST['name'])){
    ...
    if($_POST['password'] != $_POST['passwordconfirm']){
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "INSERT INTO tto_users (
                                                        image,
                                                        username,
                                                        email,
                                                        password
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "UPDATE tto_users SET
                                                        image = '$image_db',
                                                        username = '$_POST[name]',
                                                        email = '$_POST[email]',
        ...
        $query = mysqli_query($conn,"SELECT * FROM tto_users");
