...
$reslut4 = mysqli_query($conn, "SELECT * FROM tto_users WHERE username = '$username' and password = '$password'");
...
$query = mysqli_query($conn , "select * from tto_report");
...
<div class="col-md-12 text-center">
    <table class="table table-bordered">
        <thead>
        <tr>
            <th colspan="4" class="text-center" style="color:white;background-color: #63b0c8">نموذج تقييم  مكتب نقل وتسويق التكنولوجيا  TTO </th>
