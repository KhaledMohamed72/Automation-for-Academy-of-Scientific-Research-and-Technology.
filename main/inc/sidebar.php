<aside class="col-lg-3">
    ...
    <div class="list-group">
        ...
        <div style="display: none" id="myDiv">
            ...
            <a style="color: #1e88e5" target="_blank" href="../tisc/tisc_report.php" class="list-group-item">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<i class="fa fa-file" aria-hidden="true"></i><b> تقرير تقييم TISC</b></a>
            <a style="color: #1e88e5" target="_blank" href="../tto/tisc_report.php" class="list-group-item">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<i class="fa fa-file" aria-hidden="true"></i> <b>تقرير تقييم TTO</b></a>
            <a style="color: #1e88e5" target="_blank" href="../gico/tisc_report.php" class="list-group-item">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<i class="fa fa-file" aria-hidden="true"></i><b> تقرير تقييم GICO </b></a>
        </div>
