...
<html lang="ar" xmlns="http://www.w3.org/1999/html">
  <head>
    ...
    <!-- Bootstrap -->
      ...
      <script src="../../panel/tisc/js/bootstrap-show-password.min.js"></script>
  ...
  <div class="row">
      <div class="col-sm-12">
          <div class="text-center">
              <img style="max-height: 90px;width: 100%;" src="../../tisc/<?php echo $sel_image['image3']?>">
          </div>
      </div>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="pull-left">
      <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="label label-pill label-danger count" style="border-radius:10px;"></span> <span class="glyphicon glyphicon-bell" style="margin-left:50px;font-size:18px;"></span></a>
