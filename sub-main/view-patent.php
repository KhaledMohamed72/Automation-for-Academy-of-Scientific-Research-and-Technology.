...
$post =mysqli_fetch_assoc($select_post);
    ...
    if (empty($comment)) {
        ...
        $insert = mysqli_query($conn  , "insert into comments (patent_id , user_name,comment,com_date,seen_status , seen_status_ceo) values ('$id','$username','$comment' ,'$date',0 ,0)");
        if(isset($insert)) {
...
?>
    ...
    <article class="col-md-9 col-lg-9 " xmlns="http://www.w3.org/1999/html">
            ...
            <div class="cate_post" style="padding: 5px; margin: 10px 0;background: white;border: solid 1px   #E7E7E7;">
                ...
                <div class="col-md-12">
                    <div class="col-md-12" style="margin: 15px;background: #f3dcd9; font-size:20px;">
                        <p class="pull-right"><i class="fa fa-user">   اسم المخترع : <?php echo $post['inventor_name']; ?></i> | <i class="fa fa-clock-o">&ensp;</i> تاريخ الايداع :  <?php echo $post['date']; ?></p>
        ...
        <!-- comment Area -->
        <?php
        $comm = mysqli_query($conn , "select * from comments where patent_id = '$id'  order by com_date desc");
