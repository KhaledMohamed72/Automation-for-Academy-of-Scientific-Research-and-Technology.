...
$msg = '';
$select_post = mysqli_query($conn, "SELECT * FROM cources  WHERE cource_id ='$id' ");
    ...
    <article class="col-md-9 col-lg-9 " xmlns="http://www.w3.org/1999/html">
        <div class="col-md-12" art_bg >
            ...
            <div class="cate_post" style="padding: 5px; margin: 10px 0;background: white;border: solid 1px   #E7E7E7;">
                ...
                <div class="col-md-12">
                    <div class="col-md-12" style="margin: 15px;background: #f3dcd9; font-size:20px;"><p class="pull-right"><i class="fa fa-user">   الجهة المانحة : <?php echo $post['donor']; ?></i> | <i class="fa fa-clock-o">&ensp;</i> تاريخ الدورة :  <?php echo $post['date']; ?></p>
