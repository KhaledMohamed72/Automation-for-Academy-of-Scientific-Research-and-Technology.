...
if(isset($_POST['submit'])) {
    if ($_POST['password'] == $_POST['passwordconfirm']) {
        ...
        $sel_setting = mysqli_query($conn, "select * from sub_main_users");
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "INSERT INTO sub_main_users 
                                                        VALUES(
                                                                '$image_db',
                                                                '$_POST[name]',
                                                                '$_POST[email]',
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "UPDATE sub_main_users SET
        ...
        $msg = '<div class="alert alert-danger" role="alert">برجاء اعادة تاكديد كلمة المرور</div>';
    }
}

$query = mysqli_query($conn,"SELECT * FROM sub_main_users");
