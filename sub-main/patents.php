                    ...
                    while($post = mysqli_fetch_assoc($posts)){
                        ...
                        echo '
                           ...
                           <tr>
                            ...
                            <td>'.($post['status_ceo'] == 'dreft' ? '<a href="patents.php?status=published&post='.$post['patent_id'].'&page='.$page.'" class="btn btn-success btn-xs">قبول</a>' : '<a href="patents.php?status=dreft&post='.$post['patent_id'].'&page='.$page.'" class="btn btn-info btn-xs">تعليق</a>').'</td>    
