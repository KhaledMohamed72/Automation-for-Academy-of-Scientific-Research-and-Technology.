  ...
  <table class="table table-hover">
    ...
    while($row = mysqli_fetch_array($result))
    {
        ...
        <tr>
                            ...
                            <td>'.($row['status_ceo'] == 'dreft' ? '<a href="reports.php?status=published&post='.$row['patent_id'].'" class="btn btn-success btn-xs">قبول</a>' : '<a href="reports.php?status=dreft&post='.$row['patent_id'].'" class="btn btn-info btn-xs">تعليق</a>').'</td>    
