...
$query = "SELECT * FROM comments WHERE seen_status = 0 and user_name = '$tisc_user[username]' or seen_status_ceo = 0 ORDER BY id DESC";
...
$update_query = "UPDATE comments SET seen_status = 1 , seen_status_ceo = 1 WHERE seen_status = 0 or seen_status_ceo = 0";
