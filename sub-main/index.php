...
$sel_patents = mysqli_query($conn , "Select * from patents where status = 'Published' or status = 'published' ");
                ...
                <table class="table table-hover">
                    ...
                    while($post = mysqli_fetch_assoc($posts)){
                        ...
                        echo '
                            ...
                            <td>'.($post['status_ceo'] == 'dreft' ? '<a href="index.php?status=published&post='.$post['patent_id'].'&page='.$page.'" class="btn btn-success btn-xs">قبول</a>' : '<a href="index.php?status=dreft&post='.$post['patent_id'].'&page='.$page.'" class="btn btn-info btn-xs">تعليق</a>').'</td>    
                            <td><a href="view-patent.php?post='.$post['patent_id'].'" class="btn btn-warning btn-xs">مشاهدة او تعليق</a></td>                                  
                            </tr>
