        ...
        if (isset($_FILES['image']['name'])) {
            ...
            foreach($_FILES['image']['name'] as $key=>$val){
                ...
                if (in_array($ext, $supported_image)) {
                    ...
                    $insert = mysqli_query($conn, "INSERT INTO cources (cource_name ,donor ,note ,image ,date) VALUES
                                                            ('$cource_name','$donor','$note','$image_db','$date')");

                    if(isset($insert)){
                        $msg = '<div class="alert alert-info" role="alert">تم إضافة الدورة بنجاح جاري تحويلك الي الدورات</div>';
                        echo  '<meta http-equiv="refresh" content="2; \'cources.php\' "/>';
                    }
                    ...
                    $insert = mysqli_query($conn, "INSERT INTO cources (cource_name ,donor ,note  ,date) VALUES
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading"><b>إضافة دورة جديدة</b></div>
                    <div class="panel-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="donor" name="donor" value="<?php echo $donor;?>" placeholder="أدخل الجهة المانحة">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" name="add_post" class="btn btn-danger">إضافة الدورة</button>
                                </div>
                            </div>
                        </form>
                    </div>
