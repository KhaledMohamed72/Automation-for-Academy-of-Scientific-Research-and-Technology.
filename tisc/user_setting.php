...
if(isset($_POST['submit'])){
    $sel_setting =mysqli_query($conn, "select * from tisc_users");
    if(empty($_POST['name'])){
    ...
    if($_POST['password'] != $_POST['passwordconfirm']){
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "INSERT INTO tisc_users (
                                                        image,
                                                        username,
                                                        email,
                                                        password
                    ...
                    if ($image_error === 0) {
                        ...
                        if ($image_size <= 7000000) {
                            ...
                            if (move_uploaded_file($image_tmp, $image_dir)) {
                                ...
                                $insert = mysqli_query($conn, "UPDATE tisc_users SET
                                                        image = '$image_db',
                                                        username = '$_POST[name]',
                                                        email = '$_POST[email]',
        ...
        $query = mysqli_query($conn,"SELECT * FROM tisc_users");
...
<article class="col-lg-8" style="margin-right: 60px;">
    <?php echo $msg; ?>
        <div class="panel panel-info">
          ...
          <div class="panel-heading"><b>إعدادات المستخدم</b></div>
