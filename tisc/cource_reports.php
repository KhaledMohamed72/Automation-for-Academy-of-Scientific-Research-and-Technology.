        ...
        <div class="panel panel-info">
            <div class="panel-heading" style="padding-bottom: 50px">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="search_text" name="search_text"  placeholder="البحث بتفاصيل الدورة">
                    </div>
                    <a style="float: left" href="public_report.php" class="btn btn-success btn-سة">عمل تقرير عام</a>
                </div>
                <br>
                ...
                <script>
                    ...
                    <div class="col-sm-1">
                        <a  href="cource_date_report.php" class="btn btn-danger" >طباعة</a>
                    </div>
                </div>
