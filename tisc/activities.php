<?php
        ...
        if(isset($_GET['status']) and isset($_GET['post'])){
            ...
            $sql =mysqli_query($conn, "UPDATE activities SET status = '$_GET[status]' WHERE cource_id = '$_GET[post]'");
    ...
    <article class="col-lg-9">
        ...
        <div class="panel panel-info">
          <div class="panel-heading" style="padding-bottom: 25px">
              ...
              <a style="float: left" href="new_activity.php" class="btn btn-success btn-lg">اضافة نشاط جديدة</a>
          </div>
                ...
                <tbody>
                    ...
                    while($post = mysqli_fetch_assoc($posts)){
                        ...
                        echo '
                            ...
                            <td><a href="edit_activity.php?post='.$post['cource_id'].'" class="btn btn-warning btn-xs">تعديل</a></td> 
